...
class Fingerprinter
{
    public function fingerprintFile(string $input, array $ftType = []): Fingerprint
    {
        ...
        Lib::get()->Pex_Fingerprint_File($input, $buffer, $status, convertTypes($ftType));
    ...
    public function fingerprintBuffer(string $input, array $ftType = []): Fingerprint
    {
        ...
        Lib::get()->Pex_Fingerprint_Buffer($inputBuffer, $outputBuffer, $status, convertTypes($ftType));
        Error::checkStatus($status);
